...
resize_init_image = cv2.resize(init_image, (w, h), interpolation=cv2.INTER_CUBIC)  # cv2.resize的img应为ndarray
resize_init_image = cv2.cvtColor(resize_init_image, cv2.COLOR_BGR2RGB)
...
img1 = zone_ops(image, resize_init_image, mask_zone1)
